...
登录你的 163 邮箱网页版 → **设置** → **POP3/SMTP/IMAP** → 开启 **SMTP 服务** → 按提示验证 → 生成客户端授权码。关掉弹窗就看不到了，**立刻保存好**。

注意这是授权码，不是你的 163 邮箱登录密码。
...
| `EMAIL_ADDRESS` | 你的 163 邮箱 |
| `EMAIL_SMTP_AUTH_CODE` | 163 邮箱授权码 |
...
等 1-2 分钟，刷新页面看圆圈有没有变绿勾。变绿了就去 163 邮箱收件箱查收。**没有就去垃圾邮件里找找。**
